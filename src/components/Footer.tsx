...
export default function Footer() {
  ...
  return (
    <footer className="bg-white dark:bg-dark p-6 dark:text-gray-200">
    <div className=" w-full ">
     ...
     <img className=' w-32 dark:invert ' src="https://pkhdfkdxmhhrvkxglbhv.supabase.co/storage/v1/object/public/photos/logo%20black.png?t=2023-10-02T11%3A57%3A04.586Z" alt="logo" />
      ...
      <div className="flex justify-center items-center md:justify-center md:flex-col text-gray-600 hover:text-gray-900 dark:hover:text-white dark:text-white ">
          ...
          <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20" width="16" height="16">
              ...
              <span  className=" text-sm"> Moses.ka
                 
             
              </span>
         
            
              <a href="https://github.com/moses-ka" className=" ">
                  ...
                  <span className=' text-center text-sm'>Moses-ka</span>
